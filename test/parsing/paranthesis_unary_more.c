...
Test(binary_more, a_left_bcd_right_star)
{
...
Test(binary_more, left_abc_right_d_star)
{
...
Test(binary_more, left_ab_or_cd_right_star)
{
...
Test(binary_more, left_a_or_bc_or_d_right_star)
{
...
Test(binary_more, left_a_or_bc_right_star)
{
...
Test(binary_more, a_start_right_bc_left_star)
{
    Array *arr = tokenize("a*(bc)*");
...
Test(binary_more, left_ab_right_star_left_bc_right_star)
{
