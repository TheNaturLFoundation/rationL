...
Test(binary_more, left_a_right_star)
{
...
Test(binary_more, left_a_right_star_b)
{
...
Test(binary_more, left_a_right_star_or_b)
{
    Array *arr = tokenize("(a)*|b");
...
Test(binary_more, a_left_b_right_star)
{
    Array *arr = tokenize("a(b)*");
...
Test(binary_more, a_or_left_b_right_star)
{
    Array *arr = tokenize("a|(b)*");
...
Test(binary_more, left_ab_right_star)
{
...
Test(binary_more, left_a_or_b_right_star)
{
    Array *arr = tokenize("(a|b)*");
...
Test(binary_more, a_left_bc_right_star)
{
...
Test(binary_more, a_or_left_bc_right_star)
{
    Array *arr = tokenize("a|(bc)*");
