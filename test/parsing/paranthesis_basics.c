...
Test(paranthesis_basics, left_a_right)
{
...
Test(paranthesis_basics, a_left_b_right)
{
...
Test(paranthesis_basics, left_a_right_b)
{
    Array *arr = tokenize("(a)b");
...
Test(paranthesis_basics, left_ab_right)
{
...
Test(paranthesis_basics, left_a_or_b_right)
{
    Array *arr = tokenize("(a|b)");
...
Test(paranthesis_basics, left_abc_right)
{
...
Test(paranthesis_basics, left_a_or_b_or_c_right)
{
...
Test(paranthesis_basics, a_left_bc_right)
{
...
Test(paranthesis_basics, a_left_b_or_c_right)
{
    Array *arr = tokenize("a(b|c)");
...
Test(paranthesis_basics, a_or_left_bc_right)
{
    Array *arr = tokenize("a|(bc)");
...
Test(paranthesis_basics, a_or_left_b_or_c_right)
{
    Array *arr = tokenize("a|(b|c)");
...
Test(paranthesis_basics, left_ab_right_c)
{
...
Test(paranthesis_basics, left_a_or_b_right_c)
{
    Array *arr = tokenize("(a|b)c");
...
Test(paranthesis_basics, left_ab_right_or_c)
{
    Array *arr = tokenize("(ab)|c");
...
Test(paranthesis_basics, left_a_or_b_right_or_c)
{
    Array *arr = tokenize("(a|b)|c");
